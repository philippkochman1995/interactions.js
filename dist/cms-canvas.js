...
var n = Object.create, r = Object.defineProperty, i = Object.getOwnPropertyDescriptor, a = Object.getOwnPropertyNames, o = Object.getPrototypeOf, s = Object.prototype.hasOwnProperty, c = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), l = (e, t, n, o) => {
	...
	function If(e, t, n) {
		if (t.count++, t.instance === null) switch (t.type) {
			...
			case "script": return o = Pf(n.src), (a = e.querySelector(Ff(o))) ? (t.instance = a, Ot(a), a) : (r = n, (a = mf.get(o)) && (r = p({}, n), zf(r, a)), e = e.ownerDocument || e, a = e.createElement("script"), Ot(a), Pd(a, "link", r), e.head.appendChild(a), t.instance = a);
...
function D(e = Math.floor(Math.random() * 4294967295)) {
	let t = e >>> 0;
	return () => {
		t += 1831565813;
		let e = t;
...
function me(e, n) {
	...
	if (!p) return null;
	let m = de(e, "[data-canvas-title]") || ((i = e.getAttribute("data-canvas-title")) == null ? void 0 : i.trim()) || (f == null ? void 0 : f.alt.trim()) || "", h = ((a = e.getAttribute("data-canvas-id")) == null ? void 0 : a.trim()) || ((o = e.getAttribute("data-cms-item-id")) == null ? void 0 : o.trim()) || `canvas-item-${n + 1}-${E(`${m}-${p}`)}`, g = e.querySelector("[data-canvas-modal-body]"), _ = (de(e, "[data-canvas-size]") || e.getAttribute("data-canvas-size") || "").trim().toLocaleLowerCase("de"), v = _ === "mittel" ? "medium" : _ === "groß" || _ === "gross" ? "large" : "small", y = k(e), b = y[0], x = de(e, "[data-canvas-modal-hover-text]") || de(e, "[data-canvas-modal-address]") || m, S = de(e, "[data-canvas-modal-headline]") || m;
	return {
		id: h,
		title: m,
		thumbnail: p,
		...
		modal: {
			...
			layout: "context",
			headline: S,
			image: (c = b == null ? void 0 : b.src) == null ? "" : c,
			imageAlt: (l = b == null ? void 0 : b.alt) == null ? "" : l,
			caption: (u = b == null ? void 0 : b.caption) == null ? "" : u,
...
function he(e) {
	return Array.from(e.querySelectorAll(te)).map(me).filter((e) => e !== null);
}
function ge(e) {
...
function ye(e) {
	return E(`${e.sourceId}:${e.copyIndex}`) % 3 == 0 ? {
		width: 10,
		height: 14
	} : {
		width: 16,
...
function De({ placed: e }) {
	return /* @__PURE__ */ (0, C.jsxs)("button", {
		...
		}), e.tile.title ? /* @__PURE__ */ (0, C.jsx)("span", {
...
function Oe({ root: t, items: n, source: r }) {
	...
	return (0, x.useEffect)(() => {
		...
		let v = () => {
			...
			if (Math.hypot(i, a) <= (r.pointerType === "touch" ? 14 : ne)) return;
			...
			let i = Math.hypot(r.clientX - u.x, r.clientY - u.y), a = r.pointerType === "touch" ? 14 : ne;
			if (!h && i <= a && g) {
		...
		ref: i,
		children: a.map((e) => /* @__PURE__ */ (0, C.jsx)(De, { placed: e }, e.tile.instanceId))
	});
}
function ke(e) {
	var t;
	...
	let r = (t = e.querySelector(ee)) == null ? document.querySelector(ee) : t;
	if (!r) {
	...
	ie.set(e, a), a.render(/* @__PURE__ */ (0, C.jsx)(Oe, {
		root: e,
		items: i,
		source: r
	}));
...
ae(() => {
	let e = Array.from(document.querySelectorAll(w));
	if (e.length > 0) {
		e.forEach(ke);
		return;
	}
	let t = document.querySelector(ee), n = t == null ? void 0 : t.parentElement;
