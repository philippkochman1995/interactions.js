...
function _e(e) {
	...
	let n = c(re).filter((e) => p(e, "data-lightbox-group") === t.group).map(k).filter((e) => !!e), r = Math.max(0, n.findIndex((t) => t.trigger === e));
	return {
...
function M(e) {
	if (!j(e) && (e.setAttribute("role", "button"), e.hasAttribute("tabindex") || (e.tabIndex = 0), !e.hasAttribute("aria-label"))) {
		var t;
...
function ve(e) {
	...
	e.classList.remove(y), e.classList.add(le), e.before(t), t.append(e, A()), M(t);
}
function ye(e) {
	...
	O(e).trim() && (e.classList.add(x), M(e), d(ce, e) || e.append(A()));
}
function be() {
	c(b).forEach(ye);
}
...
function P() {
	...
	if (s.classList.add("site-lightbox"), s.setAttribute("data-site-lightbox", ""), s.setAttribute("role", "dialog"), s.setAttribute("aria-modal", "true"), s.setAttribute("aria-hidden", "true"), s.setAttribute("aria-label", (e = S == null ? void 0 : S.t("openImage", "Image preview")) == null ? "Image preview" : e), s.hidden = !0, s.tabIndex = -1, !o) {
		var c, l, u;
		s.innerHTML = "";
		let e = N((c = S == null ? void 0 : S.t("close", "Close")) == null ? "Close" : c, "data-lightbox-close", "", "site-lightbox__close");
		...
		let t = N((l = S == null ? void 0 : S.t("previous", "Previous")) == null ? "Previous" : l, "data-lightbox-prev", "‹", "site-lightbox__previous"), n = N((u = S == null ? void 0 : S.t("next", "Next")) == null ? "Next" : u, "data-lightbox-next", "›", "site-lightbox__next"), r = document.createElement("figure");
	...
	return C = f, F(f), !o && !document.body.contains(s) && document.body.append(s), f;
}
function F(e) {
	var t, n, r, i;
...
function R(e) {
	w.length < 2 || (T = (e + w.length) % w.length, I());
}
function z() {
	R(T + 1);
}
...
function V(e) {
	...
	if (!n) return;
	let i = E;
	w = n.items, T = n.index, D = e, E = !0, I(), L(!0), i || r();
	let a = P();
...
function H() {
	...
	L(!1), g(), E = !1, w = [], T = 0, D = null, t.image.removeAttribute("src"), t.caption.textContent = "", l(t.root, "site:lightbox-close", { item: r }), a(n);
}
function xe(t) {
	if (!(!E || !C)) {
		if (t.key === "Escape") {
			t.preventDefault(), t.stopPropagation(), t.stopImmediatePropagation(), H();
			return;
		}
		if (t.key === "ArrowRight") {
			t.preventDefault(), z();
...
function Se(e) {
	!E || !C || e.target === C.root && H();
}
function Ce(e) {
	return S = e.i18n, be(), me || (m(document, "click", re, (e, t) => {
		e.preventDefault(), V(t);
	}), m(document, "keydown", b, (e, t) => {
		j(t) || e.key !== "Enter" && e.key !== " " || (e.preventDefault(), V(t));
		...
		e.preventDefault(), z();
	}), document.addEventListener("click", Se), document.addEventListener("keydown", xe, !0), me = !0), {
		openLightbox: V,
		closeLightbox: H
	};
}
...
function Le() {
	...
	let t = {
		...
		closeButton: e.querySelector(De),
	...
	return t.closeButton.innerHTML = je, t.lightboxIcon.innerHTML = Me, ze(t), t;
}
function Re() {
	return (!W || !document.body.contains(W.root)) && (W = Le()), ze(W), W;
}
function ze(e) {
	var t, n;
...
function He(e) {
	...
	if (!l) return null;
	let u = ((t = e.querySelector("[data-modal-hover-text]")) == null || (t = t.textContent) == null ? void 0 : t.trim()) || ((n = e.querySelector("[data-modal-address]")) == null || (n = n.textContent) == null ? void 0 : n.trim()) || "", d = (r = (i = e.querySelector("[data-modal-headline]")) == null || (i = i.textContent) == null ? void 0 : i.trim()) == null ? "" : r, f = Ve(e), m = f[0], h = e.querySelector("[data-modal-body]");
	return {
		id: l,
		address: u,
...
function Ge(e) {
	...
	let n = e.trim();
	if (!n) return null;
	let r = c(Te).find((e) => p(e, "data-modal-content") === n), i = r ? He(r) : null;
...
function Xe(e, t) {
	...
	e.root.dataset.modalVariant = "context", e.root.dataset.modalId = t.id, e.address.textContent = t.address, e.imageLink.hidden = !0, e.imageLink.href = "#", e.imageLink.setAttribute("data-lightbox-src", ""), e.imageLink.setAttribute("data-lightbox-caption", ""), e.imageLink.setAttribute("data-lightbox-alt", ""), e.imageLink.setAttribute("data-lightbox-group", ""), e.image.removeAttribute("src"), e.image.alt = "", e.caption.textContent = "", e.headline.textContent = (r = t.headline) == null ? "" : r, e.headline.hidden = !t.headline, e.text.innerHTML = t.html, e.work.replaceChildren(), e.work.hidden = !t.work, e.gallery.replaceChildren(), e.gallery.hidden = i.length === 0, t.work && e.work.append(Ke(t.work)), i.forEach((t, n) => {
		e.gallery.append(qe(t, n));
	});
}
function Ze(e) {
	let t = Re();
	return e.layout === "context" ? Xe(t, e) : Ye(t, e), t;
}
function Qe(e) {
	let t = u(e.panel)[0];
	f(t == null ? e.panel : t);
...
function et(e) {
	...
	}, Ae), document.documentElement.classList.remove("is-modal-open"), document.body.classList.remove("is-modal-open");
}
function Z(e, t) {
	...
	let _ = Ze(g);
	$e(_), r(), Qe(_), l(_.root, "site:modal-open", {
		id: G,
		modal: _.root,
		content: g,
...
function $() {
	if (!G || !W) return;
	let e = G, t = K;
	et(W), g(), G = "", K = null, l(W.root, "site:modal-close", {
		id: e,
		modal: W.root
	}), a(t);
}
...
function rt(e) {
	var n;
	return Fe = (n = e.closeOnBackdrop) == null || n, U = e.i18n, We(), Re(), Pe || (m(document, "click", Ee, (e, n) => {
		e.preventDefault(), Q(t(n, "data-modal-open"), n);
	}), m(document, "click", Oe, (e, t) => {
		e.preventDefault(), Q(Ie(t), t);
	}), m(document, "click", De, (e, t) => {
		W != null && W.root.contains(t) && (e.preventDefault(), $());
	}), document.addEventListener("click", nt), document.addEventListener("keydown", tt), Pe = !0), {
		openModal: Q,
		openContentModal: Z,
		closeModal: $
	};
...
function at() {
	...
	it = !0;
	let e = ee();
	rt({ i18n: e }), Ce({ i18n: e }), n(), window.SiteInteractions = {
		openModal: Q,
		openContentModal: Z,
		closeModal: $,
		openLightbox: V,
...
document.readyState === "loading" ? document.addEventListener("DOMContentLoaded", at, { once: !0 }) : at();
//#endregion
