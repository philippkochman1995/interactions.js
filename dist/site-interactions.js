...
function za(e) {
	o("[data-modal-reveal]", e.panel).forEach((e) => {
		...
		e.setAttribute("data-modal-reveal", ""), e.style.setProperty("--modal-reveal-delay", `${90 + Math.min(t, 5) * 35}ms`);
	});
}
function Ba(e) {
